    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      <div style={{ maxWidth: 680, margin: "-20px auto 0", padding: "0 20px 80px" }}>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: 15, fontWeight: 700, color: "#0f172a" }}>{t("medcard.title")}</p>
            <p style={{ fontSize: 12, color: "#94a3b8" }}>{t("medcard.subtitle")}</p>
          </div>
        ...
        >
          <div style={iconWrap}><FaGift size={14} color="#0d9488" /></div>
          <div style={{ flex: 1 }}>
        ...
        >
          <div style={iconWrap}><FaSyringe size={14} color="#0d9488" /></div>
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: 15, fontWeight: 700, color: "#0f172a" }}>{t("courses.title")}</p>
            <p style={{ fontSize: 12, color: "#94a3b8" }}>{t("courses.subtitle")}</p>
          </div>
          <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 1l5 5-5 5" stroke="#cbd5e1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
