/**
 * HamshiraGo Design System — Medic App
 *
 * Shares the same brand palette as the client app for consistency.
...
export const Theme = {
  ...
  /* --- medic-specific: verification status --- */
  verificationPending:  '#F59E0B',
  verificationApproved: '#16A34A',
  verificationRejected: '#DC2626',

  /* --- medic-specific: online indicator --- */
  onlineGreen: '#22C55E',
  offlineGrey: '#94A3B8',
} as const;
