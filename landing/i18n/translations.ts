export const translations = {
  ru: {
    ...
    hero: {
      ...
      title2: "за 30 минут",
      subtitle:
        "Профессиональные медицинские услуги прямо у вашего порога. Укол, капельница, измерение давления — быстро, безопасно, круглосуточно.",
      appStore: "App Store",
    ...
    stats: [
      ...
      { value: 100, suffix: "+", label: "Медиков в сети" },
      { value: 4.8, suffix: "★", label: "Средний рейтинг" },
    ...
    services: {
      ...
      list: [
        { emoji: "💉", title: "Укол", desc: "Внутримышечные и подкожные инъекции любой сложности", price: "от 80 000 UZS" },
        { emoji: "🩸", title: "Капельница", desc: "Внутривенные вливания с профессиональным оборудованием", price: "от 150 000 UZS" },
    ...
    features: {
      ...
      list: [
        { icon: "⚡", title: "Быстро", desc: "Медик приедет в течение 30 минут после заказа" },
        { icon: "🔒", title: "Безопасно", desc: "Все медики проходят верификацию документов и лицензий" },
        { icon: "🌙", title: "Круглосуточно", desc: "Доступны 24/7 — ранним утром, ночью и в выходные" },
        { icon: "📍", title: "Live-трекинг", desc: "Наблюдайте за маршрутом медика в реальном времени на карте" },
        { icon: "⭐", title: "Рейтинг медиков", desc: "Честные отзывы реальных клиентов после каждого визита" },
        { icon: "💳", title: "Онлайн-оплата", desc: "Payme и Click — быстро и без наличных" },
      ],
    },
    download: {
      ...
      appStore: { sub: "Доступно в", label: "App Store" },
      googlePlay: { sub: "Доступно в", label: "Google Play" },
  ...
  uz: {
    ...
    stats: [
      ...
      { value: 100, suffix: "+", label: "Hamshiralar" },
      { value: 4.8, suffix: "★", label: "O'rtacha reyting" },
      { value: 24, suffix: "/7", label: "Yordam" },
    ],
    how: {
      badge: "Oddiy va tez",
    ...
    services: {
      ...
      list: [
        { emoji: "💉", title: "In'ektsiya", desc: "Har qanday murakkablikdagi mushak va teri osti in'ektsiyalari", price: "80 000 UZS dan" },
        { emoji: "🩸", title: "Tomchi", desc: "Professional jihozlar bilan vena ichiga eritma yuborish", price: "150 000 UZS dan" },
    ...
    features: {
      ...
      list: [
        { icon: "⚡", title: "Tez", desc: "Buyurtmadan so'ng 30 daqiqa ichida hamshira keladi" },
        { icon: "🔒", title: "Xavfsiz", desc: "Barcha hamshiralar hujjat va litsenziya tekshiruvidan o'tadi" },
        { icon: "🌙", title: "24/7", desc: "Har kuni, istalgan vaqtda — ertalab, kechasi va dam olish kunlari" },
        { icon: "📍", title: "Live-kuzatuv", desc: "Xaritada hamshira marshrutini real vaqtda kuzating" },
        { icon: "⭐", title: "Hamshira reytingi", desc: "Har bir tashrif so'ng haqiqiy mijozlarning halol sharhlari" },
        { icon: "💳", title: "Onlayn to'lov", desc: "Payme va Click — tez va naqdsiz" },
      ],
    },
    download: {
      ...
      appStore: { sub: "Mavjud", label: "App Store" },
      googlePlay: { sub: "Mavjud", label: "Google Play" },
