    ...
    <section ref={sRef} id="download" className="py-28 relative overflow-hidden"
      ...
      <div ref={ref} className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.h2
          ...
          className="text-4xl lg:text-6xl font-black mb-4 leading-tight" style={{ color: "var(--text-primary)" }}>
          {t.download.title}
        </motion.h2>
        ...
        <motion.div initial={{ opacity: 0, y: 40, scale: 0.9 }}
          ...
          <motion.a href="#" whileHover={{ scale: 1.06, y: -3 }} whileTap={{ scale: 0.97 }}
            ...
            style={{ background: "var(--text-primary)", color: "var(--bg2)", boxShadow: "0 25px 50px var(--shadow)" }}>
            <div className="absolute inset-0 bg-gradient-to-br from-white to-gray-100 opacity-0 group-hover:opacity-100 transition-opacity" />
            <svg className="relative w-7 h-7 flex-shrink-0" viewBox="0 0 814 1000" fill="currentColor">
