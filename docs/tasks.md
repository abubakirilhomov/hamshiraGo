...
- [x] **ARCH-1** — 🔴 CRITICAL / Долгосрочная архитектура — Микрофронтенд + Микросервисы: изолировать каждую часть проекта чтобы баг в одном модуле не ломал остальные — DONE 2026-04-17
